# Galerie Privacy Policy

*Last updated: February 2026*

We built Galerie to help people enjoy art on their own devices — not to collect your data. This policy explains what we do and don't do with your information.
...
**Your Art** — Images and artwork you make available to the Galerie application from your personal photo library or other sources you control.
...
We collect anonymous App Analytics to help us find and fix problems and improve the app experience. This includes things like crash reports, error logs, memory and CPU usage, screen load times, network latency, usability issues, and how often features are used. None of this data will be attribuited to you.
...
We use and share Community Ratings across the Galerie community to help the community discover art that is more relevant to their interests. Since ratings are anonymous, nothing shared can be traced back to any individual user.

### Nothing else

We do not sell or rent any data with third parties.
